...
// alert(`The valuse of sum id ${sum}`)
...
let marks = +prompt("Enter the marks in between 0-100?");
...
if (product > 0) {
  ...
  alert("The final value if negative");
}
...
let operation = prompt(`Enter an operation out of (Add, Sub, Div, Mul)`);
